...
public class LiftMutant0 {private int topFloor;
    private int currentFloor;
    private int capacity;
    private int numRiders;

    public LiftMutant0(int highestFloor) {
        this.currentFloor = 0;
        this.capacity = 10;
        this.numRiders = 0;
    ...
    public LiftMutant0(int highestFloor, int maxRiders) {
        this(highestFloor);
        this.capacity = maxRiders;
    }

    public int getTopFloor() {
        return this.topFloor != 0 ? 0 : 1;
    }
