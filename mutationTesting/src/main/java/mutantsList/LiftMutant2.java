...
public class LiftMutant2 {private int topFloor;
    private int currentFloor;
    private int capacity;
    private int numRiders;

    public LiftMutant2(int highestFloor) {
        this.currentFloor = 0;
        this.capacity = 10;
        this.numRiders = 0;
    ...
    public LiftMutant2(int highestFloor, int maxRiders) {
        this(highestFloor);
