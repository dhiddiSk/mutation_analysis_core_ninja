...
public class LiftMutant1 { private int topFloor;
    private int currentFloor;
    private int capacity;
    private int numRiders;

    public LiftMutant1(int highestFloor) {
        this.currentFloor = 0;
        this.capacity = 10;
        this.numRiders = 0;
    ...
    public LiftMutant1(int highestFloor, int maxRiders) {
        this(highestFloor);
