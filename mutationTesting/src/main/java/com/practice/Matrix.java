...
public class Matrix {
    ...
    */
    ...
    /**
    * Returns the number of rows in the com.practice.Matrix
    *
    * @return rows
    */
    public int getRows() {
    ...
    *
    * @param other : com.practice.Matrix to be added
    * @return addend
    */
    ...
    *
    * @param other : com.practice.Matrix to be subtracted
    * @return difference
    */
     ...
     *
     * @param other : com.practice.Matrix to be multiplied with
     * @return product
     */
    ...
    */
    ...
    /**
    * Returns the com.practice.Matrix as a String in the following format
    *
    * [ a b c ] ...
    * [ x y z ] ...
    * [ i j k ] ...
    *    ...
    *
    * @return com.practice.Matrix as String
    ...
    *
    * @return transposed com.practice.Matrix.
    */
